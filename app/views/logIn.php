...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Log In - Screen">
...
<body>
    ...
    <section class="p-5 m-5">
        <div class="container border border-warning p-3 rounded" style="width: 500px">
            ...
            <form action="<?php echo $data['logInAction']?>" method="POST" class="needs-validation" novalidate>
            ...
            <div class="border-top m-5 text-center">
                <?php echo $data['registerMessage']?>
                <a class="text-warning p-3" href="<?php echo $data['registerLink']?>">
                    <?php echo $data['register']?></button>
                </a>
            </div>
        </div>
    </section>
